...
Data is made available under the Creative Commons 3.0 licence (CC BY 3.0). We ask our work is acknowledged in publications that use data made available in the Brainimics/Localizer database. We are currently not asking to click buttons to formally accept the license because we wanted automated scripts to be able to easily query the database.
